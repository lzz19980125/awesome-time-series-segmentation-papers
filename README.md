...
| ![spatio-temporal forecasting](https://img.shields.io/badge/-Tensor-blue) |    *KDD '25*    | D-Tracker Modeling Interest Diffusion in Social Activity Tensor Data Streams  | [D-Tracker](https://github.com/Higashiguchi-Shingo/D-Tracker)![Stars](https://img.shields.io/github/stars/Higashiguchi-Shingo/D-Tracker) |
...
|                             TYPE                             |             Venue             |             Paper Title and Paper Interpretation             |                             Code                             |
| :----------------------------------------------------------: | :---------------------------: | :----------------------------------------------------------: | :----------------------------------------------------------: |
| ![spatio-temporal forecasting](https://img.shields.io/badge/-Tensor-blue) | *NEUCOM '26* | JT3D: Joint Temporal Segmentation for Common Pattern Discovery in 3D Tensor Time Series via Segmented Gaussian Modeling and Information-Gain | None |
...
| ![multivariate time series forecasting](https://img.shields.io/badge/-Multivariate-red) | *CIKM '25* | PromptTSS A Prompting-Based Approach for Interactive Multi-Granularity Time Series Segmentation| [PromptTSS](https://github.com/blacksnail789521/PromptTSS)|
| ![univariate time series forecasting](https://img.shields.io/badge/-Univariate-brightgreen) | *TKDE '25* | B-CAVE: A Robust Online Time Series Change Point Detection Algorithm Based on the Between-Class Average and Variance Evaluation Approach| [B-CAVE](https://github.com/Adeep2021/B-CAVE)|
| ![multivariate time series forecasting](https://img.shields.io/badge/-Multivariate-red) | *Information Fusion '25* | Identifying the temporal distribution structure in multivariate data for time-series segmentation based on two-sample test| [MIDAST](https://zenodo.org/records/15352990)|
| ![multivariate time series forecasting](https://img.shields.io/badge/-Multivariate-red) | *IEEE/CAA Journal of Automatica Sinica '25* | Multi-Scale Time Series Segmentation Network Based on Eddy Current Testing for Detecting Surface Metal Defects| [MSSN](https://github.com/ShawniLee/MSSN)![Stars](https://img.shields.io/github/stars/ShawniLee/MSSN)|
| ![multivariate time series forecasting](https://img.shields.io/badge/-Multivariate-red) | *CEP '25* | Enhanced variational autoencoder with continual learning capability for multimode process monitoring| None|
| ![multivariate time series forecasting](https://img.shields.io/badge/-Multivariate-red) | *IEEE IOTJ '25* | Multidimensional Time Series Segmentation of Human Activity Without Prior Knowledge| None|
| ![multivariate time series forecasting](https://img.shields.io/badge/-Multivariate-red) | *IEEE TIM '25* | Unsupervised Fault Detection Method via Time-Series Segmentation and Contrastive Masking Learning| None|
...
| ![univariate time series forecasting](https://img.shields.io/badge/-Univariate-brightgreen) | *Applied Energy '25* | Is it returning too hot Time series segmentation and feature clustering of end-user substation faults in district heating systems| [code](https://github.com/DanLeiria/phd/tree/main/chpt5-fdd-in-district-heating/paper-7-scripts)|
...
| ![univariate time series forecasting](https://img.shields.io/badge/-Univariate-brightgreen) | *KNOWL INF SYST. (KAIS) '24* | Optimal online time-series segmentation| [OSFS](https://github.com/ma1capoa/OSFS_Method)![Stars](https://img.shields.io/github/stars/ma1capoa/OSFS_Method)|
